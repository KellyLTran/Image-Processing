...
# The first rule, build, builds the project. The wildcards, *.cpp, targets any filename ending in .cpp.
build:
	g++ --std=c++11 -o project2.out src/*.cpp

# The second rule, run, runs all ten tasks listed in subsection 5.3.
run:
